...
func TestLoadHashFormat_ValidData(t *testing.T) {
	jsonData := `{
		"frames": {
			"RunRight01.png": {
	...
	sheet, err := loadHashFormat([]byte(jsonData))
...
func TestLoadHashFormat_InvalidJSON(t *testing.T) {
...
func TestLoadHashFormat_EmptyFrames(t *testing.T) {
	jsonData := `{
		"frames": {},
		"meta": {
			"image": "empty.png",
...
func TestLoadHashFormat_MissingFrames(t *testing.T) {
	jsonData := `{
		"meta": {
			"image": "test.png"
		}
	...
	// This should not error, just have empty sprites
	sheet, err := loadHashFormat([]byte(jsonData))
	require.NoError(t, err)
	require.NotNil(t, sheet)
	assert.Empty(t, sheet.Sprites)
...
func TestLoadHashFormat_RealFile(t *testing.T) {
